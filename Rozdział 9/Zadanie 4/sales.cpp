...
namespace SALES {
    ...
    void showSales(const SALES::Sales & s) {
        ...
        std::cout << "\nŚrednia tych wartości wynosi: " << s.average << std::endl;
        std::cout << "\nWartość minimalna tych wartości wynosi: " << s.min << std::endl;
        std::cout << "\nWartość maksymalna tych wartości wynosi: " << s.max << std::endl << std::endl;
    }
}
